...
- :eyeglasses: Считаю, что главное в разработке - качество продукта для пользователя.
- :atom: React - это любовь с первого взгляда. Хочу дальше изучать его и продвигаться в этом направлении.
- :smiling_face_with_three_hearts: Люблю создавать UI/UX дизайн и воплощать его в действительность :milky_way:
